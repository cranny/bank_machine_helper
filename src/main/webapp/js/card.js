...
var cardApp = new Vue({
    ...
    mounted: function () {
        ...
        // 查询身份信息
        var vm = this;
        axios.get(vm.queryIdCard).then(function (res) {
            vm.cardForm = Object.assign({}, vm.cardForm, res.data.responseBody.data)
            vm.cardForm.imgUrl = contextpath + vm.cardForm.imgUrl
